        ...
        <Link to="/company/create">
          <div className="card bg-base-200 hover:bg-base-300 transition-colors duration-200 cursor-pointer">
            <div className="card-body items-center text-center">
              ...
              <h3 className="text-xl font-semibold mt-2">Create New Company</h3>
            </div>
          </div>
        </Link>
        ...
        <Link to="/department/create">
          <div className="card bg-base-200 hover:bg-base-300 transition-colors duration-200 cursor-pointer">
            <div className="card-body items-center text-center">
              ...
              <h3 className="text-xl font-semibold mt-2">Create New Department</h3>
            </div>
          </div>
        </Link>
        ...
        <Link to="/employee/create">
          <div className="card bg-base-200 hover:bg-base-300 transition-colors duration-200 cursor-pointer">
            <div className="card-body items-center text-center">
              ...
              <h3 className="text-xl font-semibold mt-2">Create New Employee</h3>
            </div>
          </div>
        </Link>
        ...
        <Link to="">
          <div className="card bg-base-200 hover:bg-base-300 transition-colors duration-200 cursor-pointer">
            <div className="card-body items-center text-center">
              ...
              <h3 className="text-xl font-semibold mt-2">Create New User</h3>
            </div>
          </div>
        </Link>
      </div>
